...
IMPORTANT: 🚨 The time for the workshop is limited, so doing the three quantization techniques may take too much time. Please only do one of the INT versions (INT4 or INT8) and then FP8 which is fast as it does not need calibration data. So, either skip this section or section 3.1.
