...
Neural Magic was acquired in January 2025 by Red Hat. It was created in 2018 by MIT professor Nir Shavit and research scientist Alex Matveev, specializing in AI model optimization and accelerated inference serving. The company focuses on enabling enterprise deployment of open-source machine learning models across edge, datacenter, and cloud environments.
